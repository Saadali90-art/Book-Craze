...
import WhatsApp from "../../../assets/Footer/tempwhat.svg";
  ...
  return (
    <div className="w-full backdrop-brightness-20 ">
      <div className="container w-[70%] max-[1170px]:w-[80%] max-[924px]:w-[90%] min-h-[200px] mx-auto ">
        <div className="flex max-[1031px]:flex-col items-center justify-between  py-[30px] max-[1031px]:gap-y-[30px]">
          <div className="max-[1031px]:text-center">
            <p
              style={{ fontFamily: "Montserrat" }}
              className="text-[30px] max-[1107px]:text-[26px] text-white font-[600] "
            >
              Book Craze
            </p>
