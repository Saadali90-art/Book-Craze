    ...
    <>
      <div className="bg-white w-[350px] max-[369px]:w-[250px] h-[520px]  max-[369px]:h-[460px] rounded-md flex justify-center items-center select-none ">
        <div className=" w-[80%] h-[97%] flex flex-col ">
          ...
          />
          <h3
            className="font-[600] text-[32px] max-[369px]:text-[25px] text-transparent bg-clip-text mx-auto bg-cover pb-[10px]"
            style={{
          ...
          <div className="flex justify-end">
            <Link
              to={"/forgotpassword"}
              className="text-[11px] cursor-pointer text-blue-500 underline "
            >
              Forgot Password
            </Link>
          </div>
          <p className="py-[10px] text-[11px] text-[#747272] mx-auto pb-[5px]">
            Create New Account
