  ...
  return (
    <div>
      ...
      <main className="mt-[90px] max-[813px]:mt-[80px] max-[338px]:mt-[70px]">
        ...
        >
          ...
          <div className="text-[#f3f3f3] w-[80%] h-[400px] mx-auto text-center flex flex-col items-center justify-center">
            <p
              ...
              className="text-[35px]/[45px] font-[700] max-[590px]:text-[30px]/[35px] max-[590px]:font-[600] uppercase"
            >
        ...
        <section className="container w-[70%] max-[1170px]:w-[80%]  max-[924px]:w-[90%] max-[577px]:w-[100%] mx-auto pb-[30px] min-h-[200px] mt-[20px] max-[1392px]:mb-[20px] max-[964px]:mb-[0px]">
          <div className="w-full flex justify-between bg-pink-">
            <div className="flex items-start justify-center flex-col w-[40%] h-[220px] overflow-hidden py-[30px] pb-[30px] max-[577px]:mx-auto max-[577px]:w-[90%]">
              <p
                style={{ fontFamily: "Archivo, san-serif" }}
                className="text-[22px] max-[964px]:text-[20px] font-[700] "
              >
                Thousands of stories are waiting for you don’t miss out
              </p>
              <p
                style={{ fontFamily: "Archivo, sans-serif" }}
                className="text-lg max-[540px]:text-[16px] max-[964px]:text-[16px] mt-2"
              >
              ...
              <button
                onClick={() => handlejoin()}
                className="text-[16px] font-[600] border-black mt-[10px] cursor-pointer active:brightness-75 active:scale-95 border-[2px] flex items-center bg-white px-[10px] py-[5px] rounded-md gap-x-[5px] hover:text-white hover:bg-black/90"
              >
                Get Started
                <ArrowRight size={14} />
              </button>
